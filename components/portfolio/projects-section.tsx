...
const projects = [
  ...
  },
  {
    ...
    description: "An intelligent conversational AI application featuring natural language processing, context awareness, and seamless user experience.",
  ...
  },
  {
    ...
    description: "A comprehensive analytics dashboard for tracking investments, visualizing market trends, and managing financial portfolios.",
  ...
  },
  {
    ...
    description: "A modern social platform with real-time messaging, content sharing, and community features built for scale.",
...
export default function ProjectsSection() {
  return (
    <section id="projects" className="min-h-screen px-6 py-20 bg-gradient-to-b from-background via-secondary/20 to-background">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {projects.map((project, index) => (
            <div 
              key={index}
              className="group bg-card border border-border rounded-2xl p-6 transition-all duration-500 hover:border-primary/50 hover:shadow-2xl hover:shadow-primary/10 hover:-translate-y-1"
            >
